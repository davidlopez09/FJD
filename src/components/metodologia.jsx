...
import planificacionproyectos from "../assets/images/planificacionproyectos.jpg";
 ...
 export function Metodologia() {
    ...
    return (
        <div className="metodologia">
            <h1 className="titumeto">Utilizamos una metodología eficaz para nuestros proyectos</h1>
